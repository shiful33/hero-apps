    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center gap-4 mb-[80px]'>
                <a className='flex items-center gap-2 btn bg-white text-black text-[20px] font-semibold border-[#e5e5e5]' href=""><img src={google} alt="" />Google Play</a>
                <a className='flex items-center gap-2 btn bg-white text-black text-[20px] font-semibold border-[#e5e5e5]' href=""><img src={apple} alt="" />Apple Store</a>
            </div>
            {/* Hero Section */}
            ...
            <div className='w-full gradient-bg lg:min-h-[410px] lg:p-[80px] mb-[80px]  py-[60px] lg:py-0'>
                <div>
                ...
                <div className='lg:flex justify-center items-center text-center gap-36'>
                    <div>
            ...
            <div>
               <div className='text-center mx-[40px]'>
                <h1 className='text-[36px] lg:text-[48px] font-bold mb-[16px]'>Trending Apps</h1>
